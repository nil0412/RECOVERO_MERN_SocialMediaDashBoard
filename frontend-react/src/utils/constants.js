...
export const API_URLS = {
  ...
  fetchCommentById: (commentId) => `${API_ROOT}/comments/fetchCommentById?comment_id=${commentId}`,
  fetchCommentsByIdsArr: (commentIdsArr) => `${API_ROOT}/comments/fetchCommentsByIdsArr`,
